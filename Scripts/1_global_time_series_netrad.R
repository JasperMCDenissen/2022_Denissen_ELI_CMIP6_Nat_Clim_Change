...
mmmtseries.df_norm <- data.frame("median_norm" = c(mmmtseries.df$mmmedian_dcorr / sd(mmmtseries.df$mmmedian_dcorr - c(1:12)*kendallTrendTest(mmmtseries.df$mmmedian_dcorr)$estimate[2]),
                                                   ...
                                                   mmmtseries.df$mmmedian_netrad / sd(mmmtseries.df$mmmedian_netrad - c(1:12)*kendallTrendTest(mmmtseries.df$mmmedian_netrad)$estimate[2])),
                                 "perc25_norm" = c(mmmtseries.df$perc25_dcorr / sd(mmmtseries.df$mmmedian_dcorr - c(1:12)*kendallTrendTest(mmmtseries.df$mmmedian_dcorr)$estimate[2]),
                                                   ...
                                                   mmmtseries.df$perc25_netrad / sd(mmmtseries.df$mmmedian_netrad - c(1:12)*kendallTrendTest(mmmtseries.df$mmmedian_netrad)$estimate[2])),
                                 "perc75_norm" = c(mmmtseries.df$perc75_dcorr / sd(mmmtseries.df$mmmedian_dcorr - c(1:12)*kendallTrendTest(mmmtseries.df$mmmedian_dcorr)$estimate[2]),
                                                   ...
                                                   mmmtseries.df$perc75_netrad / sd(mmmtseries.df$mmmedian_netrad - c(1:12)*kendallTrendTest(mmmtseries.df$mmmedian_netrad)$estimate[2])),
                                 "mean_norm" = c(mmmtseries.df$mmmean_dcorr / sd(mmmtseries.df$mmmean_dcorr - c(1:12)*kendallTrendTest(mmmtseries.df$mmmean_dcorr)$estimate[2]),
                                                 ...
                                                 mmmtseries.df$mmmean_netrad / sd(mmmtseries.df$mmmean_netrad - c(1:12)*kendallTrendTest(mmmtseries.df$mmmean_netrad)$estimate[2])),
                                 "mean_minsd_norm" = c(mmmtseries.df$mmmean_minsd_dcorr / sd(mmmtseries.df$mmmean_dcorr - c(1:12)*kendallTrendTest(mmmtseries.df$mmmean_dcorr)$estimate[2]),
                                                       ...
                                                       mmmtseries.df$mmmean_minsd_netrad / sd(mmmtseries.df$mmmean_netrad - c(1:12)*kendallTrendTest(mmmtseries.df$mmmean_netrad)$estimate[2])),
                                 "mean_plussd_norm" = c(mmmtseries.df$mmmean_plussd_dcorr / sd(mmmtseries.df$mmmean_dcorr - c(1:12)*kendallTrendTest(mmmtseries.df$mmmean_dcorr)$estimate[2]),
                                                        ...
                                                        mmmtseries.df$mmmean_plussd_netrad / sd(mmmtseries.df$mmmean_netrad - c(1:12)*kendallTrendTest(mmmtseries.df$mmmean_netrad)$estimate[2])),
...
mmmtseries.df_norm$var_factor <- factor(mmmtseries.df_norm$var, levels = c("dcorr_netrad","corr_wtr_veg","corr_rgy_veg_netrad","netrad","mrso","hfls","lai","ar","pr"))
for_the_plot.df <- mmmtseries.df_norm[which(mmmtseries.df_norm$var != "pr" & mmmtseries.df_norm$var != "dpcorr" &
                                              ...
                                              mmmtseries.df_norm$var != "corr_rgy_veg" & mmmtseries.df_norm$var != "corr_wtr_veg_netrad" &
...
m4 <- ggplot(for_the_plot.df, aes(x=year,y=mean_norm,col=var_factor,fill=var_factor,linetype=var_factor,shape=var_factor)) +
  ...
  scale_color_manual("", values = cols_var, labels = c("Ecosystem Limitation Index (ELI)","cor(SM',ET')",expression("cor(R"[n]*"',ET')"),expression("Surface net radiation (R"[n]*")"),"Soil moisture (SM)", "Terrestrial evaporation (ET)", "Leaf Area Index", "Aridity Index")) +
  scale_fill_manual("", values = cols_var, labels = c("Ecosystem Limitation Index (ELI)","cor(SM',ET')",expression("cor(R"[n]*"',ET')"),expression("Surface net radiation (R"[n]*")"),"Soil moisture (SM)", "Terrestrial evaporation (ET)", "Leaf Area Index", "Aridity Index")) +
  scale_linetype_manual("", values = c(rep(1,3),2:6), labels = c("Ecosystem Limitation Index (ELI)","cor(SM',ET')",expression("cor(R"[n]*"',ET')"),expression("Surface net radiation (R"[n]*")"),"Soil moisture (SM)", "Terrestrial evaporation (ET)", "Leaf Area Index", "Aridity Index")) +
  scale_shape_manual("", values = c(16,15,17,rep(16,5)), labels = c("Ecosystem Limitation Index (ELI)","cor(SM',ET')",expression("cor(R"[n]*"',ET')"),expression("Surface net radiation (R"[n]*")"),"Soil moisture (SM)", "Terrestrial evaporation (ET)", "Leaf Area Index", "Aridity Index")) +
...
m4 <- ggplot(tseries.df, aes(x=tas_abs_1980,y=dcorr_abs_1980,group=source_id)) +
...
m4_rgy <- ggplot(tseries.df, aes(x=year,y=corr_rgy_veg_netrad_abs_1980,group=source_id)) +
  ...
  ) + ggtitle(expression("cor(R"[n]*"',ET')"))
m4_rgy

n4 <- ggplot(tseries.df, aes(x=year,y=netrad_abs_1980,group=source_id)) +
  geom_line(linetype = 'dashed', col = cols_var[2]) +
  geom_hline(yintercept=0) +
  geom_point(inherit.aes = F, data = mmmtseries.df, aes(x=year,y=mmmean_netrad), col = cols_var[2], size = 2.5) +
  geom_line(inherit.aes = F, data = mmmtseries.df, aes(x=year,y=mmmean_netrad), col = cols_var[2], linetype = 'solid', size = 1.2) +
  geom_ribbon(inherit.aes = F, data = mmmtseries.df, aes(x=year,ymin=perc25_netrad,ymax=perc75_netrad), col = cols_var[2], fill = cols_var[2], alpha = 0.5) +
  scale_x_continuous("",
                     breaks = seq(1980,2090,30),
                     labels = seq(1980,2090,30), expand = c(0,0)) +
...
#   geom_line(linetype = 'dashed', col = brewer.pal(n=9,'BrBG')[8]) +
#   geom_hline(yintercept=0) +
#   geom_point(inherit.aes = F, data = mmmtseries.df, aes(x=year,y=mmmean_corr_rgy_veg_netrad), col = brewer.pal(n=9,'BrBG')[8], size = 1.75) +
#   geom_line(inherit.aes = F, data = mmmtseries.df, aes(x=year,y=mmmean_corr_rgy_veg_netrad), col = brewer.pal(n=9,'BrBG')[8], linetype = 'solid', size = .8) +
#   geom_ribbon(inherit.aes = F, data = mmmtseries.df, aes(x=year,ymin=perc25_corr_rgy_veg_netrad,ymax=perc75_corr_rgy_veg_netrad), col = brewer.pal(n=9,'BrBG')[8], fill = brewer.pal(n=9,'BrBG')[8], alpha = 0.5) +
#   scale_x_continuous("", 
#                      breaks = seq(1980,2090,30),
#                      labels = seq(1980,2090,30), expand = c(0,0)) +
...
#   geom_line(linetype = 'dashed', col = cols_var[2]) +
#   geom_hline(yintercept=0) +
#   geom_point(inherit.aes = F, data = mmmtseries.df, aes(x=year,y=mmmean_netrad), col = cols_var[2], size = 1.75) +
#   geom_line(inherit.aes = F, data = mmmtseries.df, aes(x=year,y=mmmean_netrad), col = cols_var[2], linetype = 'solid', size = .8) +
#   geom_ribbon(inherit.aes = F, data = mmmtseries.df, aes(x=year,ymin=perc25_netrad,ymax=perc75_netrad), col = cols_var[2], fill = cols_var[2], alpha = 0.5) +
#   scale_x_continuous("", 
#                      breaks = seq(1980,2090,30),
#                      labels = seq(1980,2090,30), expand = c(0,0)) +
...
mmmtseries_pcorr.df <- data.frame("value" = c(mmmtseries.df$mmmean_dcorr_netrad, mmmtseries.df$mmmean_dpcorr,
                                              mmmtseries.df$mmmean_corr_rgy_veg_netrad, mmmtseries.df$mmmean_pcorr_rgy_veg,
                                              mmmtseries.df$mmmean_corr_wtr_veg_netrad, mmmtseries.df$mmmean_pcorr_wtr_veg),
...
m4 <- ggplot(mmmtseries_pcorr.df, aes(x=year,y=value,col=var_factor,linetype=var_factor)) +
  ...
  scale_color_manual("variable", 
                     values = cols_pcorr,
                     labels = c("ELI (cor)", "ELI (pcor)", expression("cor(R"[n]*"',ET')"), expression("cor(R"[n]*"',ET'|SM')"), "cor(SM',ET')", expression("cor(SM',ET'|R"[n]*"')"))) +
...
# # /testdir
load('testdir/202112_dcorr_cmip6_10yr_netrad.RData')
...
tseries.df <- setNames(data.frame(matrix(ncol = 15, nrow = 0)),
                       c("dcorr","corr_rgy_veg", "corr_wtr_veg", "dcorr_t", "corr_rgy_veg_t", "corr_wtr_veg_t", 
                         "hurs","VPD","evspsblveg", "hfls", "T_ET", "pr","netrad","baresoilevap","tas"))
for(i in 1:84){
  tseries.df <- rbind(tseries.df, 
                      data.frame("dcorr" = weighted.mean(x = mask_obs*dcorr_all.array[,,i], w = area.array*mask_obs, na.rm = T),
                                 "corr_rgy_veg" = weighted.mean(x = mask_obs*corr_rgy_veg_all.array[,,i], w = area.array*mask_obs, na.rm = T),
...
m4 <- ggplot(mmmtseries_t.df, aes(x=year,y=value,col=var_factor,linetype=var_factor)) +
  ...
  scale_color_manual("variable", 
                     values = cols_t,
                     labels = c(expression("ELI"), expression("ELI"[T]), expression("cor(R"[n]*"',ET')"), expression("cor(R"[n]*"',T')"), "cor(SM',ET')", expression("cor(SM',T')"))) +
  scale_linetype_manual("variable", 
                        values = linetypes_t,
                        labels = c(expression("ELI"), expression("ELI"[T]), expression("cor(R"[n]*"',ET')"), expression("cor(R"[n]*"',T')"), "cor(SM',ET')", expression("cor(SM',T')"))) +
  theme(legend.position = c(.1,.85),
